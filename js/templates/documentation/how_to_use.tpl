...
<div id="doc_content">
	...
	<div>
		...
		<ul>
			...
			<li>
                Install/create a wrapper extension for your base framework (jQuery, Prototype...)
			</li>
			<li>
				What is a module?
			</li>
	...
	<div>
		...
		<p class="h4">
            If you are interested more in the code that in examples or you're an experienced Javascript developer I recommend you to go to APIs section where you will find all the JSDoc documentation about the code. You will find a link to download it if you want to use it locally.
		</p>
	</div>
	<div>
		...
		<p>
			Your place to get all you need is <a href="#expert_documentation"><strong>Expert Documentation</strong></a> where you will find some graphs to explain the design patterns that are used in Hydra, what's the background and where you will see UML graphs.
		</p>
	</div>
</div>